...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 15f2a006-86ea-4e84-84d9-3991348680f9
```

> `15f2a006-86ea-4e84-84d9-3991348680f9` is the password of the certificate, you can change it to any password you want.
